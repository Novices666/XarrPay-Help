<template>
  <div>
    <textarea id="headerInput" rows="10" style="width: 100%; border: 1px solid #ccc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; border-radius: 8px;padding: 10px" placeholder="在这里粘贴抓到的协议头"></textarea>
    
    <button style="font-size: 1em; background-color: #10b98124; padding: 10px 20px; border: none; cursor: pointer; border-radius: 8px; margin-top: 2px;  margin-bottom: 10px;margin-right: 10px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;" @click="extractToEncryptedJSON">转换</button>
    ...
    <textarea id="encryptedOutput" rows="15" style="width: 100%; border: 1px solid #ccc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; border-radius: 8px;padding: 10px" readonly placeholder="这里显示转换后的结果" v-model="encryptedOutput"></textarea>
  </div>
</template>
